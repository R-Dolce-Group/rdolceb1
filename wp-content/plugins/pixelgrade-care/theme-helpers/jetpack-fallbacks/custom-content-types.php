...
function pixcare_jetpack_cpt_settings_api_init() {
	add_settings_section(
		'jetpack_cpt_section',
		'<span id="cpt-options">' . __( 'Your Custom Content Types', 'pixelgrade_care' ) . '</span>',
...
function pixcare_jetpack_cpt_section_callback() {
	...
	<p>
		...
		<a target="_blank"
		   href="http://jetpack.com/support/custom-content-types/"><?php esc_html_e( 'Learn More', 'pixelgrade_care' ); ?></a>
	</p>
	<?php
}
