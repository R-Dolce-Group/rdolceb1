jQuery( document ).ready( function() {
    var element = jQuery( "form.wppb-user-forms" );
        ...
        if( jQuery( element['selector'] + ' .wppb-field-error' ).length ) {
            ...
            if( element.hasClass( 'wppb-register-user' ) ) {
                ...
                if( jQuery( element['selector'] + ' .wppb-default-repeat-password' ).length ) {
                    ...
                    jQuery( '#wppb-msf-tabs-' + pass_repeat_error_step ).addClass( 'wppb-msf-commands-error' );
                    jQuery( '#wppb-msf-pagination-' + pass_repeat_error_step ).addClass( 'wppb-msf-commands-error' );
                }
            }

            jQuery( '.wppb-send-credentials-checkbox' ).closest( 'ul' ).show();
            jQuery( '.form-submit' ).show();
            jQuery( '.wppb-msf-tabs' ).prop( 'disabled', false ).attr( 'data-msf-disabled-check', 'no' );
            jQuery( '.wppb-msf-pagination' ).prop( 'disabled', false ).attr( 'data-msf-disabled-check', 'no' );

            if( ! jQuery( jQuery( '.wppb-field-error' )[0] ).is( ':visible' ) ) {
                jQuery( '#wppb-msf-step-0' ).hide();
                jQuery( jQuery( '.wppb-field-error' )[0] ).closest( 'li.wppb-msf-step' ).show();
                var step_number = jQuery( jQuery( '.wppb-field-error' )[0] ).closest( 'li.wppb-msf-step' ).attr( 'data-msf-step' );

                jQuery( '#wppb-msf-pagination' ).find( '.wppb-msf-pagination' ).removeClass( 'wppb-msf-active' );
                jQuery( '#wppb-msf-pagination' ).find( '#wppb-msf-pagination-' + step_number ).addClass( 'wppb-msf-active' );

                jQuery( '#wppb-msf-tabs' ).find( '.wppb-msf-tabs' ).removeClass( 'wppb-msf-active' );
                jQuery( '#wppb-msf-tabs' ).find( '#wppb-msf-tabs-' + step_number ).addClass( 'wppb-msf-active' );

                if( parseInt( step_number ) + 1 == count ) {
                    jQuery( '.wppb-msf-next' ).prop( 'disabled', true );
                }

                jQuery( '.wppb-msf-prev' ).prop( 'disabled', false );
...
function wppb_msf_commands( i, count, element, form_id ) {
    ...
    jQuery( ".wppb-msf-prev" ).bind( "click", function( e ) {
        e.preventDefault();

        jQuery( '.wppb-msf-next' ).prop( 'disabled', true );
        jQuery( '.wppb-msf-prev' ).prop( 'disabled', true );
        jQuery( '#wppb-msf-pagination' ).find( '.wppb-msf-pagination' ).prop( 'disabled', true );
        jQuery( '#wppb-msf-tabs' ).find( '.wppb-msf-tabs' ).prop( 'disabled', true );
        ...
        jQuery( "#" + stepName ).fadeOut( 'fast', function() {
            jQuery( '#' + form_id ).find( ".wppb-msf-spinner-container" ).fadeIn( 'fast', function() {
                ...
                jQuery( '#' + form_id ).find( ".wppb-msf-spinner-container" ).fadeOut( 'fast', function() {
                    if( i < count ) {
                        jQuery( '.wppb-msf-next' ).prop( 'disabled', false );
                    }
                    ...
                    jQuery( '#wppb-msf-pagination' ).find( '.wppb-msf-pagination' ).each( function() {
                        if( jQuery( this ).attr( 'data-msf-disabled-check' ) == 'no' ) {
                            jQuery( this ).prop( 'disabled', false );
                        }
                    } );

                    jQuery( '#wppb-msf-tabs' ).find( '.wppb-msf-tabs' ).each( function() {
                        if( jQuery( this ).attr( 'data-msf-disabled-check' ) == 'no' ) {
                            jQuery( this ).prop( 'disabled', false );
                        }
                    } );
                    ...
                    jQuery( '#wppb-msf-pagination' ).find( '.wppb-msf-pagination' ).removeClass( 'wppb-msf-active' );
                    jQuery( '#wppb-msf-pagination' ).find( '#wppb-msf-pagination-' + i ).addClass( 'wppb-msf-active' );

                    jQuery( '#wppb-msf-tabs' ).find( '.wppb-msf-tabs' ).removeClass( 'wppb-msf-active' );
                    jQuery( '#wppb-msf-tabs' ).find( '#wppb-msf-tabs-' + i ).addClass( 'wppb-msf-active' );

                    jQuery( "#wppb-msf-step-" + i ).fadeIn( 'fast', function() {
    ...
    jQuery( ".wppb-msf-next" ).bind( "click", function( e ) {
        e.preventDefault();
        ...
        jQuery( '.wppb-msf-step fieldset li.wppb-form-field' ).each( function( e ) {
            if( jQuery( this ).attr( 'class' ).indexOf( 'heading' ) == -1 && jQuery( this ).attr( 'class' ).indexOf( 'wppb_billing' ) == -1
                ...
                if( ( jQuery( this ).is( '[class*="wppb-select"]' ) || jQuery( this ).hasClass( 'wppb-select-user-role' ) ) && jQuery( this ).find( 'option:selected' ).length != 0 ) {
                ...
                if( jQuery( this ).hasClass( 'wppb-woocommerce-customer-billing-address' ) ) {
                    jQuery( 'ul.wppb-woo-billing-fields li.wppb-form-field' ).each( function() {
                ...
                if( jQuery( this ).hasClass( 'wppb-woocommerce-customer-shipping-address' ) ) {
                    jQuery( 'ul.wppb-woo-shipping-fields li.wppb-form-field' ).each( function() {
        ...
        jQuery( '#' + stepName + ' fieldset li.wppb-form-field' ).each( function() {
            if( jQuery( this ).attr( 'class' ).indexOf( 'heading' ) == -1 && jQuery( this ).attr( 'class' ).indexOf( 'wppb_billing' ) == -1
                && jQuery( this ).attr( 'class' ).indexOf( 'wppb_shipping' ) == -1 && jQuery( this ).attr( 'class' ).indexOf( 'wppb-shipping' ) == -1 ) {
            ...
            jQuery( '#' + form_id ).find( ".wppb-msf-spinner-container" ).fadeIn( 'fast', function() {
                jQuery.post( wppb_msf_data_frontend.ajaxUrl , data, function( response ) {
                    if( response == 'no_errors' ) {
                        ...
                        jQuery( '#' + stepName + ' fieldset li.wppb-form-field' ).removeClass( 'wppb-field-error' ).children().remove( '.wppb-form-error' );

                        jQuery( '#' + form_id ).find( ".wppb-msf-spinner-container" ).fadeOut( 'fast', function() {
                            jQuery( "#" + stepName ).fadeOut( 'fast', function() {
                                jQuery( "#wppb-msf-step-" + ( i + 1 ) ).fadeIn( 'fast' );

                                if( i + 2 == count && form_type != 'edit_profile' ) {
                                    jQuery( "p.form-submit" ).fadeIn( 'fast' );
                                    jQuery( ".wppb-send-credentials-checkbox" ).closest( 'ul' ).fadeIn( 'fast' );
                                }
                                ...
                                jQuery( '#wppb-msf-tabs-' + i ).removeClass( 'wppb-msf-commands-error' );
                                jQuery( '#wppb-msf-pagination-' + i ).removeClass( 'wppb-msf-commands-error' );
                                ...
                                jQuery( '#wppb-msf-pagination' ).find( '.wppb-msf-pagination' ).removeClass( 'wppb-msf-active' );
                                jQuery( '#wppb-msf-pagination' ).find( '#wppb-msf-pagination-' + i ).prop( 'disabled', false ).addClass( 'wppb-msf-active' ).attr( 'data-msf-disabled-check', 'no' );
                                ...
                                jQuery( '#wppb-msf-tabs' ).find( '.wppb-msf-tabs' ).removeClass( 'wppb-msf-active' );
                                jQuery( '#wppb-msf-tabs' ).find( '#wppb-msf-tabs-' + i ).prop( 'disabled', false ).addClass( 'wppb-msf-active' ).attr( 'data-msf-disabled-check', 'no' );
                        ...
                        jQuery.each( fields_errors, function( key, value ) {
                            ...
                            if( meta_name.length > 1 ) {
                                jQuery.each( meta_name, function( key2, value2 ) {
                                    if( jQuery( value2 ).find( 'label' ).attr( 'for' ) == key ) {
                                        jQuery( jQuery( value2 ) ).addClass( 'wppb-field-error' ).append( value['error'] );
                                    }
                                } );
                            } else {
                        ...
                        jQuery( '#' + form_id ).find( ".wppb-msf-spinner-container" ).fadeOut( 'fast', function() {
                            ...
                            jQuery( 'html, body' ).animate( {
                                scrollTop: jQuery( '.wppb-field-error' ).first().closest( 'li' ).offset().top - 100
                            }, 200 );
                        } );
                    }
                } );
    ...
    jQuery( ".wppb-msf-pagination" ).bind( "click", function( e ) {
        e.preventDefault();
        ...
        if( page.data( 'msf-step' ) != i ) {
            ...
            jQuery( '#wppb-msf-pagination' ).find( '.wppb-msf-pagination' ).removeClass( 'wppb-msf-active' ).prop( 'disabled', true );
            jQuery( page ).addClass( 'wppb-msf-active' );

            jQuery( '#wppb-msf-tabs' ).find( '.wppb-msf-tabs' ).removeClass( 'wppb-msf-active' ).prop( 'disabled', true );
            jQuery( '#wppb-msf-tabs' ).find( '#wppb-msf-tabs-' + page.data( 'msf-step' ) ).addClass( 'wppb-msf-active' );
            ...
            jQuery( "#" + stepName ).fadeOut( 'fast', function() {
                jQuery( '#' + form_id ).find( ".wppb-msf-spinner-container" ).fadeIn( 'fast', function() {
                    jQuery( '#' + form_id ).find( ".wppb-msf-spinner-container" ).fadeOut( 'fast', function() {
                        jQuery( "#" + stepName ).fadeOut( 'fast', function() {
                            jQuery( "#wppb-msf-step-" + page.data( 'msf-step' ) ).fadeIn( 'fast' );
    ...
    jQuery( ".wppb-msf-tabs" ).bind( "click", function( e ) {
        e.preventDefault();
        ...
        if( page.data( 'msf-step' ) != i ) {
            ...
            jQuery( '#wppb-msf-pagination' ).find( '.wppb-msf-pagination' ).removeClass( 'wppb-msf-active' ).prop( 'disabled', true );
            jQuery( '#wppb-msf-pagination' ).find( '#wppb-msf-pagination-' + page.data( 'msf-step' ) ).addClass( 'wppb-msf-active' );
