...
?>
<div class="wc_address_validation_postcode_lookup" id="<?php echo esc_attr( 'wc_address_validation_postcode_lookup_' . $address_type ); ?>" style="display: none;">
	...
	<p class="form-row message notes wc_address_validation_results">
