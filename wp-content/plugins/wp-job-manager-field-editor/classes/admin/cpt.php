...
class WP_Job_Manager_Field_Editor_CPT {
	...
	function update_field_post_meta( $post_id ) {
		...
		$checkboxes = apply_filters( 'field_editor_update_post_meta_checkboxes', array( 'admin_only', 'multiple', 'ajax', 'required', 'output_show_label', 'populate_enable', 'populate_save', 'option_default', 'option_disabled', 'packages_require', 'image_link', 'output_enable_fw', 'output_enable_vw', 'output_video_allowdl', 'hide_in_admin' ) );
