...
class WC_Product_Documents_Admin {
	...
	public function save_product_tab_options( $product_id ) {
		...
		if ( isset( $_POST['_wc_product_documents_title'] ) ) {
			SV_WC_Product_Compatibility::update_meta_data( $product, '_wc_product_documents_title', $_POST['_wc_product_documents_title'] );
		}
		...
		SV_WC_Product_Compatibility::update_meta_data( $product, '_wc_product_documents_display', $documents_display );
